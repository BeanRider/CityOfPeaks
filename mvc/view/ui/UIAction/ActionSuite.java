...
public class ActionSuite {
   ...
   * @param e
   */
  public void actPressed(CityOfPeaks_Controller controller, MouseEvent e) {
   ...
   * @param e
   */
  public void actPressedOutside(CityOfPeaks_Controller controller, MouseEvent e) {
   ...
   * @param e
   */
  public void actHovered(CityOfPeaks_Controller controller, MouseEvent e) {
   ...
   * @param e
   */
  public void actScrolled(CityOfPeaks_Controller controller, MouseEvent e) {
   ...
   * @param e
   */
  public void actDragged(CityOfPeaks_Controller controller, MouseEvent e) {
   ...
   * @param e
   */
  public void actReleased(CityOfPeaks_Controller controller, MouseEvent e) {
